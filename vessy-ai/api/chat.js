    ...
    try {
        ...
        const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { role: "system", content: "You are Vessy OS 28, a high-performance AI created by Athul. If asked for code, wrap it in markdown blocks." },
