export async function onRequestPost(context) {
    try {
        ...
        let systemPrompt = `You are Vessy OS 31.1, a personalized AI assistant made by Athul Sanoj. You should be smart and respond in quick and short but also detailed and long answers at the same time. Athul's father is Sanoj and his mother is Bincy. The user is "${username || 'Guest'}".
