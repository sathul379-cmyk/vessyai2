export async function onRequestPost(context) {
    try {
        ...
        const { adminToken, action, username, ip, banType, durationMinutes, banReason, kickReason } = await request.json();

        if (!['check-status', 'check-kick'].includes(action) && !await validateAdminSession(env, adminToken)) {
